    ...
    <div className="min-h-screen bg-surface-950 flex flex-col items-center">
      ...
      <section className="w-full max-w-2xl px-6 pb-8 flex items-center gap-3">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-6 py-3 border border-surface-600 rounded-md text-surface-200 hover:text-surface-50 hover:border-surface-400 transition-colors text-sm font-medium"
        >
