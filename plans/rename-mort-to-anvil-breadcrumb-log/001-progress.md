...
## Done
- Phase 1 complete: All Rust backend files renamed (Cargo.toml, build.rs, all .rs files in src-tauri/src/)
...
- The __MORT_APP_SUFFIX__ and __MORT_WS_PORT__ defines are used in src/ code — those references also need updating in the TS source files that consume them
