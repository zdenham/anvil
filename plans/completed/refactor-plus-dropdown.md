...
- [x] Phase 1: Convert "+" button to "new thread +" pill
- [x] Phase 2: Add "new workspace in [repo] +" to repo section footer
- [x] Phase 3: Add "Create pull request" button to ChangesView header
- [x] Phase 4: Scope bottom tab bar to show only terminals from active worktree
- [x] Phase 5: Remove stale actions from context menu
- [x] Phase 6: Clean up unused props threading
