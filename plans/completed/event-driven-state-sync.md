...
- [x] Phase 1: Event chain + patch-based state emission
- [x] Phase 2: Frontend patch application + gap detection
- [x] Phase 3: Delta-based streaming (replace full-snapshot `OPTIMISTIC_STREAM`)
