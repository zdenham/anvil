...
- [x] Create comment store and service (entity layer)
- [x] Register COMMENT_* events in event bridge and agent routing
- [x] Add Zustand-in-context provider for diff comment scope
- [x] Build UI: comment gutter button and inline comment form
- [x] Build UI: comment display and resolution controls
- [x] Wire diff components to render comments via context
- [x] Add "Address Comments" agent spawn flow
- [x] Write frontend tests (store + service)
