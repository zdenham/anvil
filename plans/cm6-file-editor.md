...
- [ ] Install CM6 dependencies and create the `CodeMirrorEditor` component
- [ ] Create language-to-CM6 mapping adapter
- [ ] Integrate into `file-content.tsx`, replacing `HighlightedFileView`
- [ ] Add dirty state tracking and save (Cmd+S) support
- [ ] Style/theme the editor to match the app
