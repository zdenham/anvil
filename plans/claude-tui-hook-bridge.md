...
6. **SessionStart context**: Inject only Mort-specific context (thread ID, parent thread ID, plan context, worktree path). Claude auto-discovers CLAUDE.md, git, env natively — no duplication.
