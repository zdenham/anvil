...
type AuthMethod = "claude-login" | "api-key";

export function AuthSettings() {
  const authMethod = useSettingsStore((s) => s.workspace.authMethod ?? "claude-login") as AuthMethod;
  ...
  const handleChange = async (method: AuthMethod) => {
    await settingsService.set("authMethod", method);
  };
